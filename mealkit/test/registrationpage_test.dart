...
//--------------------------donot proceed until fields are filled-------------------------------------//
    ...
    expect(find.byType(HomeView), findsNothing); //replace welcome with a keyword from the page that registration button will load
...
//------------------------proceed if all the fields are filled-----------------------------------------//
    ...
    expect(find.byType(HomeView), findsOneWidget); //replace welcome with a keyword from the page that registration button will load
}